...
build-test/test_main.o: test.h test_main.cpp
	mkdir -p build-test && g++ -c -std=c++11 -pedantic -Wextra -Wall -g -o build-test/test_main.o test_main.cpp

build-test/test.o: test.h test.cpp
	mkdir -p build-test && g++ -c -std=c++11 -pedantic -Wextra -Wall -g -o build-test/test.o test.cpp
